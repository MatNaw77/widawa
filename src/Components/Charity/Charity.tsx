...
export function Charity({ className = "" }: Props) {
  return (
    <section className={`max-w-5xl mx-auto px-6 py-12 ${className}`}>
      ...
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="text-gray-700 mb-2">
          Od 2013 roku łączymy ludzi wokół piłki nożnej, pasji i zdrowego stylu
          życia.
        </p>
        <p className="text-gray-700">
          Dla nas futbol to coś więcej niż rywalizacja — to radość, współpraca i
          rozwój, które towarzyszą zarówno najmłodszym, jak i seniorom.
        </p>
      </div>
      ...
      <div className="mt-16 grid md:grid-cols-2 gap-10 items-start">
        <div>
          ...
          <p className="mt-4 text-gray-700">
            Naszą największą dumą są dzieci i młodzież, w których drzemie
            przyszłość futbolu. Wspieramy talenty, ale równie mocno stawiamy na
            tych, którzy po prostu chcą aktywnie spędzać czas i być częścią
            drużyny.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-4 text-gray-700">
            ...
            <li>
              ...
              <p className="text-sm">
                Sport uczy dobrych nawyków i daje energię na co dzień — od
                najmłodszych lat.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p className="text-sm">
                Szacunek, odpowiedzialność i uczciwa gra — wartości, które
                przenosimy z boiska do życia codziennego.
              </p>
            </li>
          </ul>
        </div>
      ...
      <div className="mt-16">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <li>
            Organizujemy treningi, turnieje i wydarzenia dla lokalnej
            społeczności.
          </li>
          <li>
            Wspieramy talenty, ale też otwieramy drzwi każdemu, kto chce grać.
          </li>
          <li>
            Realizujemy inicjatywy sportowe i edukacyjne w naszej dzielnicy.
          </li>
        </ul>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <dd className="text-sm">
                Działamy z pasji, przejrzyście i społecznie
              </dd>
            </div>
          </div>
        </dl>
      ...
      <div className="mt-16 text-center">
        ...
        <p className="text-gray-700 max-w-2xl mx-auto">
          Każda złotówka i każdy gest pomocy wraca do młodych piłkarzy i naszej
          społeczności. Działamy społecznie — bez etatów, z pasji.
        </p>
