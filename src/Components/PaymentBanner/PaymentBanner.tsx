    ...
    return (
        <section className="w-full bg-red-800 text-white mt-20 min-h-[69vh] flex items-center">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row">
                ...
                ${accepted ? "bg-red-600 cursor-pointer" : "bg-red-400 cursor-not-allowed"}`}
                            >
                                {a === "inna" ? (
                                    <>
                                        Wpłacam <br />
                    ...
                    <div className="mt-8 text-sm">
                        ...
                        <p className="text-xs text-gray-200">
                            Przekazane darowizny na konto Stowarzyszenia Futbolu Widawa Wrocław
                            wykorzystywane są na działalność statutową.
                        </p>
