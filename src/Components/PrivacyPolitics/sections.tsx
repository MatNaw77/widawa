export const sections = [
    ...
    {
        title: "4. Cel i podstawa prawna przetwarzania danych osobowych",
        content: (
            <>
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <ul className="list-disc list-inside">
                    <li>personel Stowarzyszenia upoważniony do przetwarzania,</li>
                    <li>podmioty IT świadczące usługi na rzecz Administratora,</li>
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <ul className="list-disc list-inside">
                    <li>wymagany przepisami prawa okres,</li>
                    <li>okres niezbędny do wykonania umowy i przedawnienia roszczeń,</li>
                    <li>do momentu cofnięcia zgody (jeśli dotyczy zgody).</li>
                </ul>
            </>
        ),
    },
    ...
    {
        title: "13. Wtyczki społecznościowe",
        content: (
            <p>
