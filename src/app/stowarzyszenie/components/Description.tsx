...
export const Description: FC = () => (
    <div className="max-w-5xl mx-auto px-6 py-12 dark:text-gray-100">
        {/* Misja */}
        <div className="mt-16 grid md:grid-cols-2 gap-10 items-start">
            <div>
                <h2 className="text-2xl font-semibold mb-4 dark:text-gray-100">🎯 Nasza misja</h2>
            ...
            <div>
                ...
                <ul className="space-y-4 text-gray-700">
                    ...
                    <li>
                        <span className="font-medium dark:text-gray-100">💚 Zdrowy styl życia</span>
                        <p className="text-sm">
                    ...
                    <li>
                        <span className="font-medium dark:text-gray-100">🤝 Wspólnota</span>
                        <p className="text-sm">
                    ...
                    <li>
                        <span className="font-medium dark:text-gray-100">🌍 Fair Play</span>
                        <p className="text-sm">
        ...
        {/* Jak działamy */}
        <div className="mt-16">
            <h2 className="text-2xl font-semibold mb-4 dark:text-gray-100">📌 Jak działamy?</h2>
        ...
        {/* W skrócie */}
        <div className="mt-16">
            <h2 className="text-2xl font-semibold mb-6 dark:text-gray-100">📊 W skrócie</h2>
            <dl className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700">
                <div className="flex items-center gap-3">
                    <CalendarDays className="w-5 h-5 text-green-600" />
                    <div>
                        <dt className="font-medium dark:text-gray-100">2013</dt>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <dt className="font-medium dark:text-gray-100">Drużyny</dt>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <dt className="font-medium dark:text-gray-100">Siedziba</dt>
